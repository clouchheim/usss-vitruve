...
# synchronise startDate window for the dedup existence check - wider than
# VITRUVE_DATE_RANGE as a buffer against timezone slop, per the user's
# "could do 8 to be safe with time changes" call.
